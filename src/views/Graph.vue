...
export default {
    ...
    mounted() {
        ...
        Highcharts.chart('container4',this.option4),
        Highcharts.chart('container5',this.option5),
        Highcharts.addEvent(
                Highcharts.Series,
                'afterSetOptions',
                function (e) {
        ...
        Highcharts.chart('container8', {
            ...
            xAxis: {
                ...
                // min: 0,
                // max: 360,
                categories: ["Item1", "Item2", "Item3", "Item4", "Item5", "Item6","Item6","Item6"],
                labels: {
                    // myArray: [0, 1, 2, 3, 4, 5],
                    // format: '{value}°',
                    
                    // format:'{#each(myArray,-1)}',
                    style: {
                        // color: 'red',
                        fontSize: '15px'
                    }
