...
<script>
// import csv from '../world-population-history.csv'
...
import Data from 'highcharts/modules/data' // 数据处理模块可以使用ajax
...
export default {
    ...
    mounted() {
        Highcharts.ajax({
            // data:'../world-population-history.csv',
            url: 'https://cdn.jsdelivr.net/gh/highcharts/highcharts@v7.0.0/samples/data/world-population-history.csv',
            // csv:'../world-population-history.csv',
            // csvURL:window.location.origin+'world-population-history.csv',
            dataType: 'csv',
            ...
            success: function (csv) {
                ...
                var mapData = Highcharts.geojson(worldmap)
                ...
                mapChart = Highcharts.mapChart('container11', {
